 ...
 * <!-- end-user-doc -->
 * @see org.sisostds.schemas.ieee1516._2010._2010Package#getFixedRecordEncodingEnumeration()
 * @model extendedMetaData="name='fixedRecordEncodingEnumeration'"
 * @generated
 */
public final class FixedRecordEncodingEnumeration extends AbstractEnumerator {
	/**
	 ...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #HL_AFIXED_RECORD_LITERAL
	 * @model name="HLAfixedRecord"
	 * @generated
	 * @ordered
	 */
	public static final int HL_AFIXED_RECORD = 0;
	 ...
	 * @ordered
	 */
	public static final FixedRecordEncodingEnumeration HL_AFIXED_RECORD_LITERAL = new FixedRecordEncodingEnumeration(HL_AFIXED_RECORD, "HLAfixedRecord", "HLAfixedRecord");
	...
	public static FixedRecordEncodingEnumeration get(int value) {
		switch (value) {
			case HL_AFIXED_RECORD: return HL_AFIXED_RECORD_LITERAL;
		}
		return null;
	}
