...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Turn Interactions On Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.TurnInteractionsOnTypeImpl#getIdtag <em>Idtag</em>}</li>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.TurnInteractionsOnTypeImpl#getIsCallback <em>Is Callback</em>}</li>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.TurnInteractionsOnTypeImpl#isIsUsed <em>Is Used</em>}</li>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.TurnInteractionsOnTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.TurnInteractionsOnTypeImpl#getSection <em>Section</em>}</li>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.TurnInteractionsOnTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TurnInteractionsOnTypeImpl extends MinimalEObjectImpl.Container implements TurnInteractionsOnType {
	/**
	 ...
	 * @ordered
	 */
	protected static final Object SECTION_EDEFAULT = "5.12";
	 ...
	 * @generated
	 */
	protected TurnInteractionsOnTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return _2010Package.eINSTANCE.getTurnInteractionsOnType();
	}
	...
	public void setIdtag(String newIdtag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2010Package.TURN_INTERACTIONS_ON_TYPE__IDTAG, oldIdtag, idtag));
	}
	...
	public void setIsCallback(Object newIsCallback) {
		...
		isCallbackESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2010Package.TURN_INTERACTIONS_ON_TYPE__IS_CALLBACK, oldIsCallback, isCallback, !oldIsCallbackESet));
	}
	...
	public void unsetIsCallback() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _2010Package.TURN_INTERACTIONS_ON_TYPE__IS_CALLBACK, oldIsCallback, IS_CALLBACK_EDEFAULT, oldIsCallbackESet));
	}
	...
	public void setIsUsed(boolean newIsUsed) {
		...
		isUsedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2010Package.TURN_INTERACTIONS_ON_TYPE__IS_USED, oldIsUsed, isUsed, !oldIsUsedESet));
	}
	...
	public void unsetIsUsed() {
		...
		isUsedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _2010Package.TURN_INTERACTIONS_ON_TYPE__IS_USED, oldIsUsed, IS_USED_EDEFAULT, oldIsUsedESet));
	}
	...
	public void setNotes(List newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2010Package.TURN_INTERACTIONS_ON_TYPE__NOTES, oldNotes, notes));
	}
	...
	public void setSection(Object newSection) {
		...
		sectionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2010Package.TURN_INTERACTIONS_ON_TYPE__SECTION, oldSection, section, !oldSectionESet));
	}
	...
	public void unsetSection() {
		...
		sectionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _2010Package.TURN_INTERACTIONS_ON_TYPE__SECTION, oldSection, SECTION_EDEFAULT, oldSectionESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _2010Package.TURN_INTERACTIONS_ON_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
