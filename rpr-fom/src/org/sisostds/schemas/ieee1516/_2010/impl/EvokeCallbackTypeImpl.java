...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Evoke Callback Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.EvokeCallbackTypeImpl#getIdtag <em>Idtag</em>}</li>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.EvokeCallbackTypeImpl#getIsCallback <em>Is Callback</em>}</li>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.EvokeCallbackTypeImpl#isIsUsed <em>Is Used</em>}</li>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.EvokeCallbackTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.EvokeCallbackTypeImpl#getSection <em>Section</em>}</li>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.EvokeCallbackTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EvokeCallbackTypeImpl extends MinimalEObjectImpl.Container implements EvokeCallbackType {
	/**
	 ...
	 * @ordered
	 */
	protected static final Object SECTION_EDEFAULT = "10.41";
	 ...
	 * @generated
	 */
	protected EvokeCallbackTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return _2010Package.eINSTANCE.getEvokeCallbackType();
	}
	...
	public void setIdtag(String newIdtag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2010Package.EVOKE_CALLBACK_TYPE__IDTAG, oldIdtag, idtag));
	}
	...
	public void setIsCallback(Object newIsCallback) {
		...
		isCallbackESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2010Package.EVOKE_CALLBACK_TYPE__IS_CALLBACK, oldIsCallback, isCallback, !oldIsCallbackESet));
	}
	...
	public void unsetIsCallback() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _2010Package.EVOKE_CALLBACK_TYPE__IS_CALLBACK, oldIsCallback, IS_CALLBACK_EDEFAULT, oldIsCallbackESet));
	}
	...
	public void setIsUsed(boolean newIsUsed) {
		...
		isUsedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2010Package.EVOKE_CALLBACK_TYPE__IS_USED, oldIsUsed, isUsed, !oldIsUsedESet));
	}
	...
	public void unsetIsUsed() {
		...
		isUsedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _2010Package.EVOKE_CALLBACK_TYPE__IS_USED, oldIsUsed, IS_USED_EDEFAULT, oldIsUsedESet));
	}
	...
	public void setNotes(List newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2010Package.EVOKE_CALLBACK_TYPE__NOTES, oldNotes, notes));
	}
	...
	public void setSection(Object newSection) {
		...
		sectionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2010Package.EVOKE_CALLBACK_TYPE__SECTION, oldSection, section, !oldSectionESet));
	}
	...
	public void unsetSection() {
		...
		sectionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _2010Package.EVOKE_CALLBACK_TYPE__SECTION, oldSection, SECTION_EDEFAULT, oldSectionESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _2010Package.EVOKE_CALLBACK_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _2010Package.EVOKE_CALLBACK_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _2010Package.EVOKE_CALLBACK_TYPE__IDTAG:
				return getIdtag();
			case _2010Package.EVOKE_CALLBACK_TYPE__IS_CALLBACK:
				return getIsCallback();
			case _2010Package.EVOKE_CALLBACK_TYPE__IS_USED:
				return isIsUsed() ? Boolean.TRUE : Boolean.FALSE;
			case _2010Package.EVOKE_CALLBACK_TYPE__NOTES:
				return getNotes();
			case _2010Package.EVOKE_CALLBACK_TYPE__SECTION:
				return getSection();
			case _2010Package.EVOKE_CALLBACK_TYPE__ANY_ATTRIBUTE:
