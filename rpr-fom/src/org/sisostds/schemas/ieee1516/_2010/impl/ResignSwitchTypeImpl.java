 ...
 * </p>
 * <ul>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.ResignSwitchTypeImpl#getIdtag <em>Idtag</em>}</li>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.ResignSwitchTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.ResignSwitchTypeImpl#getResignAction <em>Resign Action</em>}</li>
 *   <li>{@link org.sisostds.schemas.ieee1516._2010.impl.ResignSwitchTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResignSwitchTypeImpl extends MinimalEObjectImpl.Container implements ResignSwitchType {
	 ...
	 * @ordered
	 */
	protected static final ResignActionType RESIGN_ACTION_EDEFAULT = ResignActionType.NO_ACTION_LITERAL;
	...
	protected EClass eStaticClass() {
		return _2010Package.eINSTANCE.getResignSwitchType();
	}
	...
	public void setIdtag(String newIdtag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2010Package.RESIGN_SWITCH_TYPE__IDTAG, oldIdtag, idtag));
	}
	...
	public void setNotes(List newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2010Package.RESIGN_SWITCH_TYPE__NOTES, oldNotes, notes));
	}
	...
	public void setResignAction(ResignActionType newResignAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2010Package.RESIGN_SWITCH_TYPE__RESIGN_ACTION, oldResignAction, resignAction, !oldResignActionESet));
	}
	...
	public void unsetResignAction() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _2010Package.RESIGN_SWITCH_TYPE__RESIGN_ACTION, oldResignAction, RESIGN_ACTION_EDEFAULT, oldResignActionESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _2010Package.RESIGN_SWITCH_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
