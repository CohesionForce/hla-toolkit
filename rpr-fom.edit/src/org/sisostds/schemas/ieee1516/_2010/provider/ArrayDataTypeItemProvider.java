...
/**
 * This is the item provider adapter for a {@link org.sisostds.schemas.ieee1516._2010.ArrayDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayDataTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getArrayDataType_Idtag(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getArrayDataType_Notes(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_2010Package.eINSTANCE.getArrayDataType_Name());
			childrenFeatures.add(_2010Package.eINSTANCE.getArrayDataType_DataType());
			childrenFeatures.add(_2010Package.eINSTANCE.getArrayDataType_Cardinality());
			childrenFeatures.add(_2010Package.eINSTANCE.getArrayDataType_Encoding());
			childrenFeatures.add(_2010Package.eINSTANCE.getArrayDataType_Semantics());
			childrenFeatures.add(_2010Package.eINSTANCE.getArrayDataType_Any());
			childrenFeatures.add(_2010Package.eINSTANCE.getArrayDataType_AnyAttribute());
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getArrayDataType_Name(),
				 _2010Factory.eINSTANCE.createIdentifierType()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getArrayDataType_DataType(),
				 _2010Factory.eINSTANCE.createReferenceType()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getArrayDataType_Cardinality(),
				 _2010Factory.eINSTANCE.createCardinalityType()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getArrayDataType_Encoding(),
				 _2010Factory.eINSTANCE.createArrayDatatypeEncodingType()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getArrayDataType_Semantics(),
