...
/**
 * This is the item provider adapter for a {@link org.sisostds.schemas.ieee1516._2010.ConfirmAttributeOwnershipAcquisitionCancellationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfirmAttributeOwnershipAcquisitionCancellationTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getConfirmAttributeOwnershipAcquisitionCancellationType_Idtag(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getConfirmAttributeOwnershipAcquisitionCancellationType_IsCallback(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getConfirmAttributeOwnershipAcquisitionCancellationType_IsUsed(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getConfirmAttributeOwnershipAcquisitionCancellationType_Notes(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getConfirmAttributeOwnershipAcquisitionCancellationType_Section(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_2010Package.eINSTANCE.getConfirmAttributeOwnershipAcquisitionCancellationType_AnyAttribute());
		}
