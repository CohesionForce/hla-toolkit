...
/**
 * This is the item provider adapter for a {@link org.sisostds.schemas.ieee1516._2010.FixedRecordDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FixedRecordDataTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getFixedRecordDataType_Idtag(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getFixedRecordDataType_Notes(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_2010Package.eINSTANCE.getFixedRecordDataType_Name());
			childrenFeatures.add(_2010Package.eINSTANCE.getFixedRecordDataType_Encoding());
			childrenFeatures.add(_2010Package.eINSTANCE.getFixedRecordDataType_Semantics());
			childrenFeatures.add(_2010Package.eINSTANCE.getFixedRecordDataType_Field());
			childrenFeatures.add(_2010Package.eINSTANCE.getFixedRecordDataType_Any());
			childrenFeatures.add(_2010Package.eINSTANCE.getFixedRecordDataType_AnyAttribute());
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getFixedRecordDataType_Name(),
				 _2010Factory.eINSTANCE.createIdentifierType()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getFixedRecordDataType_Encoding(),
				 _2010Factory.eINSTANCE.createFixedRecordEncodingType()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getFixedRecordDataType_Semantics(),
				 _2010Factory.eINSTANCE.createString()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getFixedRecordDataType_Field(),
				 _2010Factory.eINSTANCE.createFieldType()));
	}
