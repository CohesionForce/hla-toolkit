...
/**
 * This is the item provider adapter for a {@link org.sisostds.schemas.ieee1516._2010.ArrayDataTypesType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayDataTypesTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getArrayDataTypesType_Idtag(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getArrayDataTypesType_Notes(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_2010Package.eINSTANCE.getArrayDataTypesType_ArrayData());
			childrenFeatures.add(_2010Package.eINSTANCE.getArrayDataTypesType_Any());
			childrenFeatures.add(_2010Package.eINSTANCE.getArrayDataTypesType_AnyAttribute());
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getArrayDataTypesType_ArrayData(),
				 _2010Factory.eINSTANCE.createArrayDataType1()));
	}
