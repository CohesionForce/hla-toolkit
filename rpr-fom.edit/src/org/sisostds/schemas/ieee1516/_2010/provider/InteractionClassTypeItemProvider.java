...
/**
 * This is the item provider adapter for a {@link org.sisostds.schemas.ieee1516._2010.InteractionClassType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InteractionClassTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getInteractionClassType_Idtag(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getInteractionClassType_Notes(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_2010Package.eINSTANCE.getInteractionClassType_Name());
			childrenFeatures.add(_2010Package.eINSTANCE.getInteractionClassType_Sharing());
			childrenFeatures.add(_2010Package.eINSTANCE.getInteractionClassType_Dimensions());
			childrenFeatures.add(_2010Package.eINSTANCE.getInteractionClassType_Transportation());
			childrenFeatures.add(_2010Package.eINSTANCE.getInteractionClassType_Order());
			childrenFeatures.add(_2010Package.eINSTANCE.getInteractionClassType_Semantics());
			childrenFeatures.add(_2010Package.eINSTANCE.getInteractionClassType_Parameter());
			childrenFeatures.add(_2010Package.eINSTANCE.getInteractionClassType_InteractionClass());
			childrenFeatures.add(_2010Package.eINSTANCE.getInteractionClassType_Any());
			childrenFeatures.add(_2010Package.eINSTANCE.getInteractionClassType_AnyAttribute());
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getInteractionClassType_Name(),
				 _2010Factory.eINSTANCE.createIdentifierType()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getInteractionClassType_Sharing(),
				 _2010Factory.eINSTANCE.createSharingType()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getInteractionClassType_Dimensions(),
				 _2010Factory.eINSTANCE.createDimensionsType()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getInteractionClassType_Transportation(),
				 _2010Factory.eINSTANCE.createReferenceType()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getInteractionClassType_Order(),
				 _2010Factory.eINSTANCE.createOrderType()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getInteractionClassType_Semantics(),
				 _2010Factory.eINSTANCE.createString()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getInteractionClassType_Parameter(),
				 _2010Factory.eINSTANCE.createParameterType1()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getInteractionClassType_InteractionClass(),
