...
/**
 * This is the item provider adapter for a {@link org.sisostds.schemas.ieee1516._2010.UpdateRateType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateRateTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getUpdateRateType_Idtag(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 _2010Package.eINSTANCE.getUpdateRateType_Notes(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(_2010Package.eINSTANCE.getUpdateRateType_Name());
			childrenFeatures.add(_2010Package.eINSTANCE.getUpdateRateType_Rate());
			childrenFeatures.add(_2010Package.eINSTANCE.getUpdateRateType_Semantics());
			childrenFeatures.add(_2010Package.eINSTANCE.getUpdateRateType_Any());
			childrenFeatures.add(_2010Package.eINSTANCE.getUpdateRateType_AnyAttribute());
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getUpdateRateType_Name(),
				 _2010Factory.eINSTANCE.createIdentifierType()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getUpdateRateType_Rate(),
				 _2010Factory.eINSTANCE.createRateType()));

		newChildDescriptors.add
			(createChildParameter
				(_2010Package.eINSTANCE.getUpdateRateType_Semantics(),
